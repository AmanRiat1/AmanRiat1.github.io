...
function disableDates(date) {
    ...
    if ($('#john').is(':checked')){
        if (mechanicUnavailableDates['john'].includes(date.getDay()))
            return [false];
    }else if ($('#mike').is(':checked')){
        if (mechanicUnavailableDates['mike'].includes(date.getDay()))
            return [false];
    }
...
$(document).ready(function(){
    ...
    //https://stackoverflow.com/questions/34346983/jquery-hover-event-for-input-textbox-is-not-working/34347028
